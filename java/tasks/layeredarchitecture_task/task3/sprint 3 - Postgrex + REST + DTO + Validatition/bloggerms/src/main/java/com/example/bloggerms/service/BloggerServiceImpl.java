...
public class BloggerServiceImpl implements IBloggerService {
	...
	@Override
	public Blogger register(String firstName, String lastName, BloggerType bloggerType) throws InvalidNameException {
		validateName(firstName);
		validateName(lastName);
		Blogger blogger = new Blogger(firstName, lastName, bloggerType);
	...
	@Override
	public Blogger changeBloggerName(long id, String newFirstName, String newLastName) throws IdNotFoundException, InvalidIdException, InvalidNameException {
		validateId(id);
